...
local function CastStart(self, event, unit)
	...
	local name, _, texture, startTime, endTime, isTradeSkill, castID, interruptible, spellID = UnitCastingInfo(unit)
	event = 'UNIT_SPELLCAST_START'
	if(not name) then
		name, _, texture, startTime, endTime, isTradeSkill, interruptible, spellID = UnitChannelInfo(unit)
